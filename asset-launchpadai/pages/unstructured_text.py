...
from tabs import tab_1_exec_sum_unstructured_text, tab_2_test_plot, tab_3_word_frequency_plot, tab_4_topic_dist_plot, \
...
unstructured_text_layout = html.Div([
    ...
    dcc.Tabs(
        ...
        children=[
            ...
            dcc.Tab(
                label='Optimal number of Topics',
                value='tab-8',
                className='custom-tab',
                selected_className='custom-tab--selected'
            ),
...
def render_content(tab):
    ...
    if tab == 'tab-1':
        return tab_1_exec_sum_unstructured_text.layout
    elif tab == 'tab-2':
        ...
        return tab_8_optimal_num_topics_plot.layout
#     elif tab == 'tab-9':
